          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => setView('HOME')}>
             {appLogo ? (
                ...
                <div className="h-10 w-10 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-lg">
                    {(settings.branding?.appTitle || 'K').charAt(0)}
                </div>
             )}
             <div className="flex flex-col">
                <span className="font-bold text-xl text-gray-900 tracking-tight leading-none">{settings.branding?.appTitle || 'KamiKita'}</span>
      ...
      <footer className="bg-slate-900 text-white py-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
           <div className="md:col-span-2">
               <h4 className="text-xl font-bold mb-4">{settings.branding?.appTitle || 'KamiKita'}</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center text-slate-600 text-sm mt-12 pt-8 border-t border-slate-800">
          &copy; {new Date().getFullYear()} {settings.branding?.appTitle || 'KamiKita'}. {settings.landingPage?.footer?.copyrightText}
        </div>
      </footer>
